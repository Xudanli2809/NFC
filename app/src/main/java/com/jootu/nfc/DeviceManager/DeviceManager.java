...
import com.jootu.nfc.Card.CpuCard;
import com.jootu.nfc.Card.DESFire;
import com.jootu.nfc.Card.FeliCa;
import com.jootu.nfc.Card.Iso14443bCard;
import com.jootu.nfc.Card.Iso15693Card;
import com.jootu.nfc.Card.Mifare;
import com.jootu.nfc.Card.Ntag21x;
import com.jootu.nfc.Card.Ultralight;
...
public class DeviceManager {
    ...
    public Mifare mifare;   //x 现在只考虑M1卡
    ...
    public onReceiveAutoSearchCardListener mOnReceiveAutoSearchCardListener;    //  自动查找卡
    public onReceiveChangeBleNameListener mOnReceiveChangeBleNameListener;  //修改蓝牙名
    ...
    public final static byte  CARD_TYPE_ISO4443_A = 0x01;        //卡片类型ISO14443-A,,,,ISO14443A协议的Cpu芯片，是CPU片
    ...
    public final static byte  CARD_TYPE_ULTRALIGHT = 0x06;      //RF_TYPE_MF,,,,,Ultralight卡
