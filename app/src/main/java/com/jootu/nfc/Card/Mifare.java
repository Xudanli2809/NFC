...
import com.jootu.nfc.Exception.CardNoResponseException;
...
public class Mifare extends Card {
    ...
    public final static byte  PHAL_MFC_CMD_RESTORE   = (byte) 0xC2;    /**< 恢复MIFARE Classic Restore command byte */
    public final static byte  PHAL_MFC_CMD_INCREMENT = (byte) 0xC1;    /**< 增加MIFARE Classic Increment command byte */
    public final static byte  PHAL_MFC_CMD_DECREMENT = (byte) 0xC0;    /**< 减少MIFARE Classic Decrement command byte */
    public final static byte  PHAL_MFC_CMD_TRANSFER  = (byte) 0xB0;    /**< 传递MIFARE Classic Transfer command byte */
    public final static byte  PHAL_MFC_CMD_READ      = (byte) 0x30;    /**< 读MIFARE Classic Read command byte */
    public final static byte  PHAL_MFC_CMD_WRITE     = (byte) 0xA0;    /**< 写MIFARE Classic Write command byte */
    public final static byte  PHAL_MFC_CMD_AUTHA     = (byte) 0x60;    /**< 证明，验证MIFARE Classic Authenticate A command byte */
    public final static byte  PHAL_MFC_CMD_AUTHB     = (byte) 0x61;    /**< MIFARE Classic Authenticate B command byte */

    public final static byte  PHAL_MFC_CMD_PERSOUID  = (byte) 0x40;    /**< 个人化MIFARE Classic Personalize UID command */
...
//        });
    ...
    /*增值回调，isSuc:true表示增值成功，false表示增值失败*/
    ...
    /*减值回调，isSuc:true表示减值成功，false表示减值失败*/
    ...
    /**卡读值操作，bBlockNo:要读的地址块，通过listener回调************************************************************************************/
    /*
    ...
    */
    ...
    //[in]  bBlockNo  block number to be written.要写的块
     ...
     * @param bBlockNo  block number to be written.要写的块
    ...
    */
    ...
    /***检查块数据是否为Value格式（可增减值）   pBlock：块数据，16字节***************************************************************/
