...
public class Card {
    ...
    public byte[] uid;  //只有CpuCard类、Mifare卡类、Ntag21x类、Ultralight类支持uid
    public byte[] atr;  //卡片的ATS或者ATR
    ...
    public String uidToString() {
        ...
        StringBuffer stringBuffer = new StringBuffer(); //StringBuffer是字符串变量，它的对象是可以扩充和修改的。
     ...
     * @param listener 操作结果会通过onReceiveCloseListener回调，即上面的接口
     */
